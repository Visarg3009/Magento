...
class Ccc_Vendor_Block_Adminhtml_Product_Attribute_Set_Main extends Mage_Adminhtml_Block_Template
{
    ...
    protected function _prepareLayout()
    {
        ...
        // $deleteUrl = $this->getUrlSecure('*/adminhtml_product_set/delete', array('id' => $setId));
    ...
    {
        return $this->getUrl('*/adminhtml_product_set/save', array('id' => $this->_getSetId()));
    }

    public function getGroupUrl()
    {
        return $this->getUrl('*/adminhtml_product_group/save', array('id' => $this->_getSetId()));
    }

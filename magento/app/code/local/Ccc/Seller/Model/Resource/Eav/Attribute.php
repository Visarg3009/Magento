 ...
 */
class Ccc_Seller_Model_Resource_Eav_Attribute extends Mage_Eav_Model_Entity_Attribute
{
    const SCOPE_STORE                           = 0;
    ...
    const ENTITY                                = 'seller_eav_attribute';
     ...
     * @var string
     */
    protected $_eventPrefix                     = 'seller_entity_attribute';
    /**
     * Event object name
     *
     * @var string
    ...
    protected function _beforeSave()
    {
        if ($this->getFrontendInput() == 'multiselect') {
            $this->setBackendModel('eav/entity_attribute_backend_array');
        }
    ...
    public static function initLabels($storeId = null)
    {
        if (is_null(self::$_labels)) {
            ...
            $attributes = Mage::getResourceSingleton('seller/seller')->getAttributesByCode();

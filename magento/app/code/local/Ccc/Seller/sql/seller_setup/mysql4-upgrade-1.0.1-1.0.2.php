...
$table = $installer->getConnection()
    ->newTable($installer->getTable('seller/eav_attribute'))
    ...
    ->addIndex(
        $installer->getIdxName('seller/eav_attribute', array('used_for_sort_by')),
        array('used_for_sort_by')
    )
    ->addIndex(
        $installer->getIdxName('seller/eav_attribute', array('used_in_product_listing')),
        array('used_in_product_listing')
    )
    ->addForeignKey(
        $installer->getFkName('seller/eav_attribute', 'attribute_id', 'eav/attribute', 'attribute_id'),
        'attribute_id',
    ...
    ->setComment('seller EAV Attribute Table');

$query = "ALTER TABLE `seller_varchar` ADD UNIQUE( `attribute_id`, `store_id`, `entity_id`)";
...
$setup->addAttribute(Ccc_Seller_Model_Resource_Seller::ENTITY, 'firstname', array(
    'group'                      => 'General',
    'input'                      => 'text',
    'type'                       => 'varchar',
    'label'                      => 'firstname',
    ...
    'global'                     => Ccc_Seller_Model_Resource_Eav_Attribute::SCOPE_STORE,

));

$setup->addAttribute(Ccc_Seller_Model_Resource_Seller::ENTITY, 'lastname', array(
    'group'                      => 'General',
    'input'                      => 'text',
    'type'                       => 'varchar',
    'label'                      => 'lastname',
...
$setup->addAttribute(Ccc_Seller_Model_Resource_Seller::ENTITY, 'email', array(
    'group'                      => 'General',
    'input'                      => 'text',
    'type'                       => 'varchar',
    'label'                      => 'email',
...
$setup->addAttribute(Ccc_Seller_Model_Resource_Seller::ENTITY, 'phoneNo', array(
    'group'                      => 'General',
    'input'                      => 'text',
    'type'                       => 'varchar',
    'label'                      => 'phoneNo',
